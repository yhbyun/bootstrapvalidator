        ...
        concat: {
            source: {
                ...
                src: ['<%= dirs.src %>/js/bootstrapValidator.js', '<%= dirs.src %>/js/validator/*.js',
                    '!<%= dirs.src %>/js/validator/base64.js',
                    '!<%= dirs.src %>/js/validator/color.js',
                    '!<%= dirs.src %>/js/validator/cusip.js',
                    '!<%= dirs.src %>/js/validator/cvv.js',
                    '!<%= dirs.src %>/js/validator/ean.js',
                    '!<%= dirs.src %>/js/validator/grid.js',
                    '!<%= dirs.src %>/js/validator/hex.js',
                    '!<%= dirs.src %>/js/validator/hexColor.js',
                    '!<%= dirs.src %>/js/validator/iban.js',
                    '!<%= dirs.src %>/js/validator/id.js',
                    '!<%= dirs.src %>/js/validator/imei.js',
                    '!<%= dirs.src %>/js/validator/imo.js',
                    '!<%= dirs.src %>/js/validator/isbn.js',
                    '!<%= dirs.src %>/js/validator/isin.js',
                    '!<%= dirs.src %>/js/validator/ismn.js',
                    '!<%= dirs.src %>/js/validator/issn.js',
                    '!<%= dirs.src %>/js/validator/mac.js',
                    '!<%= dirs.src %>/js/validator/meid.js',
                    '!<%= dirs.src %>/js/validator/phone.js',
                    '!<%= dirs.src %>/js/validator/rtn.js',
                    '!<%= dirs.src %>/js/validator/sedol.js',
                    '!<%= dirs.src %>/js/validator/siren.js',
                    '!<%= dirs.src %>/js/validator/siret.js',
                    '!<%= dirs.src %>/js/validator/step.js',
                    '!<%= dirs.src %>/js/validator/uuid.js',
                    '!<%= dirs.src %>/js/validator/vat.js',
                    '!<%= dirs.src %>/js/validator/vin.js',
